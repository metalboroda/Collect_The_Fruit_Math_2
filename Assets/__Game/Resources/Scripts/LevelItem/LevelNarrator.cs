...
namespace Assets.__Game.Resources.Scripts.LevelItem
{
  public class LevelNarrator : MonoBehaviour
  {
    ...
    private EventBinding<EventStructs.TreeItemClickEvent> _itemClickEvent;
    ...
    private void OnEnable()
    {
      ...
      _itemClickEvent = new EventBinding<EventStructs.TreeItemClickEvent>(PlayItemSOund);
    }
    ...
    private void OnDisable()
    {
      ...
      _itemClickEvent.Remove(PlayItemSOund);
    }
    ...
    private void PlayItemSOund(EventStructs.TreeItemClickEvent treeItemClickEvent)
    {
      _audioSource.Stop();
